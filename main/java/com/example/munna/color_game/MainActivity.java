...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final CountDownTimer countDownTimer=new CountDownTimer(20000,1000) {
            ...
            public void onFinish() {
                ...
                ad.setTitle("TIME'S UP  !!!");
                ad.setMessage("You Are Failed....");
                ad.show();
            }
        }.start();
    ...
    public void endgame(){
        ...
        if (score==9){
            ...
            builder.setTitle("First Level Completed");
            builder.setMessage("Are U Want To Continue Your Game ?");
